        ...
        <form action="" method="post">
            <div id="formContainer">
                ...
                <div class="checkBoxes">
                    <input type="checkbox" id="legalNotice" name="legalNotice">
                    <label for="legalNotice"><span>Legal notice text to confirm the login</span></label>
                    </br>
                    <input type="checkbox" id="subsc" name="subsc">
                    <label for="subsc"><span>Subscribe to our channel</span></label>
                </div>
            </div>
            <button type="submit" class="submit"><a href="<?php echo $theme_path?>/HTML/personalAccount.php">Create my account</a></button>
        </form>
        <div id="stickyRegister">
