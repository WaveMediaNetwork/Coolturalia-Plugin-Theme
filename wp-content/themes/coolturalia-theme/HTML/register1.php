...
<div id="content-mobile">
    ...
    <main>
        ...
        <div id="interests">
            ...
            <button type="button" class="next"><a href="<?php echo $theme_path?>/HTML/register2.php">Next</a></button>
        </div>
...
<script>
    ...
    interests.forEach(interest =>interest.addEventListener("click", (e) => {
